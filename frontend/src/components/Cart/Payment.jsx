...
import googlePayIcon from "../../assets/images/PayIcons/google-pay-icon.png";
import paytmIcon from "../../assets/images/PayIcons/paytm-icon.png";
import phonepeIcon from "../../assets/images/PayIcons/phonepe-icon.png";
// import {
//     CardNumberElement,
//     CardCvcElement,
//     CardExpiryElement,
          ...
          <div className="flex-1">
            <Stepper activeStep={3}>
              <div className="w-full bg-white px-4">
                <a
                  href={`phonepe://pay?pa=mab.037323013380091@axisbank&cu=INR&am=${totalPrice}`}
                ...
                <hr></hr>
                <a
                  href={`tez://upi/pay?pa=mab.037323013380091@axisbank&cu=INR&am=${totalPrice}`}
                  className="payment_button"
                >
                  <img
                    draggable="false"
                ...
                <hr></hr>
                <a
                  href={`paytmmp://pay?pa=mab.037323013380091@axisbank&pn=Cozy&am=${totalPrice}&cu=INR`}
                  className="payment_button"
                >
                  <img
                    draggable="false"
